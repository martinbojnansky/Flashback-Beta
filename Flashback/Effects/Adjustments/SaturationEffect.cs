...
namespace Flashback.Effects.Adjustments
{
    ...
    { 
        public override string Title { get; } = "Saturation";
        public override string Icon { get; } = "Saturation.png";
        public override Type ControlType { get; } = typeof(IntensityEffectView);
        public override PropertySet Properties { get; set; } = SaturationVideoEffect.GetDefaultProperties();

        public override void ApplyEffect(MediaClip mediaClip, MediaComposition mediaComposition)
        {
            mediaClip.VideoEffectDefinitions.Add(new VideoEffectDefinition(typeof(SaturationVideoEffect).FullName, Properties));
        }
