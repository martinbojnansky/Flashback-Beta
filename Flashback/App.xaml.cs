...
namespace Flashback
{
    ...
    {
        //public static Helpers.Navigation.NavigationService NavigationService = new Helpers.Navigation.NavigationService();
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            Color inactiveForegroundColor = Colors.Black;
            StatusBarHelper.CustomizeTitleBar(darkBackgroundColor, foregroundColor, darkBackgroundColor, inactiveForegroundColor,
                darkBackgroundColor, foregroundColor, backgroundColor, foregroundColor, lightBackgroundColor, foregroundColor, darkBackgroundColor, inactiveForegroundColor);
