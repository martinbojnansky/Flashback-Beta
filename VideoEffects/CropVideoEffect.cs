...
{
    public sealed class CropVideoEffect : IBasicVideoEffect
    {
        ...
        public void ProcessFrame(ProcessVideoFrameContext context)
        {
            ...
            using (CanvasDrawingSession ds = renderTarget.CreateDrawingSession())
            {
                ...
                {
                    Source = inputBitmap,
                    SourceRectangle = new Rect(0, _croppedBounds.Top, _croppedBounds.CroppedWidth, _croppedBounds.CroppedHeight)
                };
