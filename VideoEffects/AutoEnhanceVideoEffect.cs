...
{
    public sealed class AutoEnhanceVideoEffect : IBasicVideoEffect
    {
        CanvasDevice canvasDevice;
        Direct3DSurfaceImageSource m_direct3DSurfaceImageSource;
        AutoEnhanceEffect m_Effect = new AutoEnhanceEffect() { IsContrastAndBrightnessEnhancementEnabled = true, IsLocalBoostEnhancementEnabled = true };
