...
{
    public sealed class SharpnessVideoEffect : IBasicVideoEffect
    {
        ...
        public float Intensity
        {
            get
            {
                return Convert.ToSingle(_configuration[nameof(Intensity)]) / 33;
            }
        }
        ...
        public void ProcessFrame(ProcessVideoFrameContext context)
        {
            ...
            {
                var sharpen = new SharpenEffect()
                {
                    Source = inputBitmap,
                    Amount = Intensity
                };
                ds.DrawImage(sharpen);
            }
        }
